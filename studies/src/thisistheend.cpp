// g++ -o thisistheend thisistheend.cpp `root-config --cflags --libs` && ./thisistheend
...
// Plane 0  
  ral[0]=-19*M_PI/180;   fal[0]=26*M_PI/180;
  rbe[0]=1*M_PI/180;    fbe[0]=0*M_PI/180;
  rga[0]=3*M_PI/180;    fga[0]=0*M_PI/180;
  rTx[0]=10;
  rTy[0]=-3;
  rTz[0]=43000;		fTz[0]=43000;
// Plane 1  
  ral[1]=-18*M_PI/180;   fal[1]=26*M_PI/180;
  rbe[1]=2*M_PI/180;    fbe[1]=0*M_PI/180;
  rga[1]=5*M_PI/180;    fga[1]=0*M_PI/180;
  rTx[1]=-40;
  rTy[1]=30;
  rTz[1]=41000;		fTz[1]=41000;
// Plane 2  
  ral[2]=4*M_PI/180;    fal[2]=0*M_PI/180;
  rbe[2]=23*M_PI/180;   fbe[2]=-26*M_PI/180;
  rga[2]=-5*M_PI/180;    fga[2]=0*M_PI/180;
  rTx[2]=30;
  rTy[2]=-40;
  rTz[2]=27000;		fTz[2]=27000;
// Plane 3  
  ral[3]=-3*M_PI/180;    fal[3]=0*M_PI/180;
  rbe[3]=16*M_PI/180;   fbe[3]=-26*M_PI/180;
  rga[3]=-5*M_PI/180;    fga[3]=0*M_PI/180;
  rTx[3]=40;
  rTy[3]=70;
  rTz[3]=25000;		fTz[3]=25000;
// Plane 4  
  ral[4]=4*M_PI/180;    fal[4]=0*M_PI/180;
  rbe[4]=23*M_PI/180;   fbe[4]=-26*M_PI/180;
  rga[4]=-3*M_PI/180;    fga[4]=0*M_PI/180;
  rTx[4]=-30;
  rTy[4]=30;
  rTz[4]=-25000;	fTz[4]=-25000;  
// Plane 5  
  ral[5]=3*M_PI/180;   	fal[5]=0*M_PI/180;
  rbe[5]=22*M_PI/180;	fbe[5]=-26*M_PI/180;
  rga[5]=2*M_PI/180;    fga[5]=0*M_PI/180;
  rTx[5]=-30;
  rTy[5]=50;
  rTz[5]=-27000;	fTz[5]=-27000;
// Plane 6  
  ral[6]=-18*M_PI/180;   fal[6]=26*M_PI/180;
  rbe[6]=-4*M_PI/180;    fbe[6]=0*M_PI/180;
  rga[6]=3*M_PI/180;    fga[6]=0*M_PI/180;
  rTx[6]=30;
  rTy[6]=-40;
  rTz[6]=-41000;	fTz[6]=-41000;  
// Plane 7  
  ral[7]=-22*M_PI/180;   fal[7]=26*M_PI/180;
  rbe[7]=1*M_PI/180;    fbe[7]=0*M_PI/180;
  rga[7]=-2*M_PI/180;    fga[7]=0*M_PI/180;
  rTx[7]=10;
  rTy[7]=-20;
...
//  int ntracks=10000;	// Number of tracks per iteration
 ...
 for(int j=0; j<10000; ++j)
 {
  ...
  { 
   ...
   xmeas[j][i]=rNX/rD+rTx[i]+r->Gaus(0,8/*sigx[i]*/);
   ymeas[j][i]=rNY/rD+rTy[i]+r->Gaus(0,8/*sigy[i]*/);
